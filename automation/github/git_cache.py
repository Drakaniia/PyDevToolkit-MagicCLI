...
class GitCacheMenu(Menu):
    ...
    def __init__(self):
        ...
        super().__init__("💾 Git Cache Operations")
    
    def setup_items(self):
        """Setup menu items for git cache operations"""
        self.items = [
            MenuItem("Create Cache Point", lambda: self.git_cache.create_cache_point()),
            ...
            MenuItem("Remove Sensitive Files from History", lambda: self.git_cache.remove_sensitive_files()),
