...
class MenuNavigation:
    ...
    def get_choice_with_arrows(
        self, items: List[Any], renderer: Any, initial_display: bool = True
    ) -> int:
            ...
            while True:
                try:
                    ...
                    if (
                        ...
                        and (current_time - last_key_time) < key_debounce_time
                    ):
                        continue
