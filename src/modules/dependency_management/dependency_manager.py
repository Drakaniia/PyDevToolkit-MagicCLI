...
class DependencyManager:
    ...
    def _update_all_packages(
            self, outdated_packages: List[Dict[str, str]]) -> None:
    ...
    def setup_items(self) -> None:
        ...
        self.items = [
            MenuItem(
                ...
                self.dep_manager.run_security_scan),
            MenuItem(
                "Check for Dependency Updates",
                self.dep_manager.check_dependency_updates),
            MenuItem(
                "Verify Lock Files",
                self.dep_manager.verify_lock_files),
            MenuItem(
                "Back to Main Menu",
                lambda: "exit")]
