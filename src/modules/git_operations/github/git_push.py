            ...
            if result.returncode == 0 and result.stdout.strip():
                ...
                if summary_line:
                    ...
                    if match:
                        ...
                        print(f"{Fore.CYAN}║{Style.RESET_ALL} {Fore.BLUE}📁 Files Changed:{Style.RESET_ALL} {files_changed:<3} {Fore.CYAN}│{Style.RESET_ALL} {Fore.GREEN}➕ Insertions:{Style.RESET_ALL} {insertions:<4} {Fore.CYAN}│{Style.RESET_ALL} {Fore.RED}➖ Deletions:{Style.RESET_ALL} {deletions:<20} {Fore.CYAN}║{Style.RESET_ALL}")
                        print(f"{Fore.CYAN}╟{'─'*78}╢{Style.RESET_ALL}")
