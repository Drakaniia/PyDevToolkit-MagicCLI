...
# Import GroqCommitGenerator for AI commit message generation
...
class GitPushRetry:
    ...
    def push_with_retry(
        ...
        Args:
            commit_message: Commit message (if staging changes) - if None, will be generated automatically
    ...
    def _generate_multiple_commit_messages(self) -> Optional[List[Dict]]:
        ...
        try:
            ...
            # Initialize the Groq commit generator
...
class GitPush:
    ...
    def push(self, dry_run: bool = False):
        ...
        if hasattr(self, '_pending_commits') and self._pending_commits:
            ...
            # Single commit - pass commit message to push_with_retry which will handle staging and committing
    ...
    def _get_commit_message(self) -> Optional[str]:
        """Get commit message using AI generation with thorough code analysis"""
        try:
            ...
            # Analyze all changes with loading animation
            changes_info = None
            ...
            # Generate AI commit message for all changes together with loading animation
            commit_message = None
            with LoadingSpinner("AI analyzing code changes and generating commit message...", style="dots"):
            ...
            print(f"\n   Error generating AI commit message: {e}")
            return None
